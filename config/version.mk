...
ifneq (,$(filter $(KRAKEN_BUILD_TYPE),ALPHA BETA))
    KRAKEN_VERSION := Kraken-$(KRAKEN_MOD_VERSION)-$(KRAKEN_BUILD_ZIP_TYPE)-$(KRAKEN_BUILD_DATE)-$(CURRENT_DEVICE)-$(KRAKEN_BUILD_TYPE)-UNOFFICIAL
else
